...
import {fetchVisitLogs} from "@/service/clientService.js";
...
async function getVisitLogs() {
  const data = await fetchVisitLogs(clientId)
      ...
      <VCardText class="mt-4">
        <VDataTableVirtual
          :headers="[
            ...
            { title: 'Manzil', value: 'client_address', width: '300' },
