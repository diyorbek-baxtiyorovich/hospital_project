...
import {updateLocalCode, getLocalCodeById} from "@/service/localCodeService.js"
...
async function getLocalCodeDataById() {
  const result = await getLocalCodeById(props.updatingItem.id)
  if (result) {
...
async function onUpdate() {
  ...
  const result = await updateLocalCode(props.updatingItem.id, submitCredentials.value)
